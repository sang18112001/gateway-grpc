...
func (x *LabelRef) GetId() string {
	if x, ok := x.GetValue().(*LabelRef_Id); ok {
		return x.Id
	}
	return ""
}
...
func (x *LabelRef) GetName() *LabelRef_Name {
	if x, ok := x.GetValue().(*LabelRef_Name_); ok {
		return x.Name
	}
	return nil
}
...
func (x *ScopedLabelRef) GetId() string {
	if x, ok := x.GetValue().(*ScopedLabelRef_Id); ok {
		return x.Id
	}
	return ""
}
...
func (x *ScopedLabelRef) GetName() string {
	if x, ok := x.GetValue().(*ScopedLabelRef_Name); ok {
		return x.Name
	}
	return ""
}
...
func file_buf_registry_module_v1_label_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buf_registry_module_v1_label_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Label); i {
			case 0:
				return &v.state
			case 1:
		...
		file_buf_registry_module_v1_label_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CommitCheckState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_registry_module_v1_label_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_buf_registry_module_v1_label_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*ScopedLabelRef); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_registry_module_v1_label_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*LabelRef_Name); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
