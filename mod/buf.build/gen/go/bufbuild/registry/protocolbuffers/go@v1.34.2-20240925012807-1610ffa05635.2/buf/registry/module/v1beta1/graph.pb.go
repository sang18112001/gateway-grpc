...
func file_buf_registry_module_v1beta1_graph_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buf_registry_module_v1beta1_graph_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Graph); i {
			case 0:
				return &v.state
			case 1:
		...
		file_buf_registry_module_v1beta1_graph_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Graph_Commit); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_registry_module_v1beta1_graph_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Graph_Node); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_registry_module_v1beta1_graph_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Graph_Edge); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
