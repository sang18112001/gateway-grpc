...
func file_buf_registry_owner_v1_owner_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buf_registry_owner_v1_owner_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Owner); i {
			case 0:
				return &v.state
			case 1:
		...
		file_buf_registry_owner_v1_owner_proto_msgTypes[1].Exporter = func(v any, i int) any {
