...
func file_buf_registry_module_v1_graph_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buf_registry_module_v1_graph_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Graph); i {
			case 0:
				return &v.state
			case 1:
		...
		file_buf_registry_module_v1_graph_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_buf_registry_module_v1_graph_proto_msgTypes[2].Exporter = func(v any, i int) any {
