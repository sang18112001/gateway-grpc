...
func file_buf_registry_owner_v1_owner_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_buf_registry_owner_v1_owner_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_buf_registry_owner_v1_owner_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
